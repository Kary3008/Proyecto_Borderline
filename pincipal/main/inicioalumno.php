...
<head>
    ...
    <meta name="description" content="Inicio de sesión para administrativos del colegio Conalep Naucalpan I, Gestion del plantel a travez de modulos como son: resgistro de asistencias,
    ...
    <!-- palabras clave -->
    <meta name="keywords" content="Inicio de sesión, Sistema Online, Reportes de Asistencia, Recorrido Virtual, Juegos Interactivos, Guia de estudiantes, Conalep Naucalpan I, Gestion de planteles">
    <!-- autor del sitio web -->
...
<body>
    <div align="center" class="containers" style="margin-top: 2em; width: 45%; margin-left: auto; margin-right:auto;">
        <div class="container py-3" style="border: 2px solid rgb(132, 196, 214); color: #000; border-radius: 5%; height:auto;">
            ...
            <h3 class="text-center py-2">Iniciar Sesión En Tu Cuenta <br>Alumno</h3>
            <div class="card">
